        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-grid shadow-sm">
              <button name="submit" class="btn btn-primary" onclick="addCat()">Add Category</button>
            </div>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-grid shadow-sm">
              <button name="submit" class="btn btn-primary" onclick="update()">Update Category</button>
            </div>
          </div>
