...
if (isset($_SESSION['admin'])) {
  if (isset($_POST['id'])) {
    ...
    $sex = $row['sex'];
    $phone = $row['phone'];
    $l_sql = "SELECT * FROM classes WHERE id = $level_id;";
    $l_result = mysqli_query($conn, $l_sql);
    $l_row = mysqli_fetch_assoc($l_result);
    $className = $l_row['class_name'];
    // get image
     ...
     <main class="center">
        <div class="photo-card shadow d-flex align-items-center justify-content-center m-3">
            <div class="card-content">
             ...
             <div class="card-body d-flex">
                ...
                <div class="text">
                    ...
                    <div class="line d-flex">
                        <div class="line-text">
                            <p><?php echo $school_short_name. "/". $studentID; ?></p>
            ...
            <div class="courses-list">
                <ul>
                  <?php
                  $e_sql = "SELECT * FROM users_enrollment WHERE student_id = $id;";
            ...
            <div class="note-list">
                <ul>
                    <li>This photocard will be used to admit candidates into the examination hall</li>
                    <li>This photocard is not transferrable. The Council reserves the right to withdraw it if further screening reveals that it was obtained through examination malpractice or any form of irregularity.
                    </li>
                </ul>
            </div>
            </div>
