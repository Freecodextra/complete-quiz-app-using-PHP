...
<?php
    ...
    <main>
            ...
            while ($row3 = mysqli_fetch_assoc($result3)) {
              ...
              while ($row5 = mysqli_fetch_assoc($result5)) {
                ...
                if ($option_id == $answer) {
                  ...
                  echo '<div class="option">
                  <span>'.$alpha[$y].'.</span>
                  <input type="checkbox" name="option" id="option'.$y.'" disabled>
     ...
     <div class="btns d-flex justify-content-center mb-3">
       <a href="./index.php?user=<?php echo $user_id; ?>" target="_blank" rel="noopener noreferrer" class="btn text-primary border-primary mx-1">Dashboard</a>
      <button class="btn btn-primary" type="submit" name="restart">Re-Attempt</button>
     </div>
     </form>
    </main>
    </div>
