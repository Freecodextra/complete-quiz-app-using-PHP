        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-grid shadow-sm">
              <button type="submit" class="btn btn-primary" onclick="addNotification()">Add Notification</button>
            </div>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-grid shadow-sm">
              <button type="submit" class="btn btn-primary" onclick="updateNotification()">Update Notification</button>
            </div>
          </div>
